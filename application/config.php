...
return  [
	...
	// | 系统数据加密设置
	// +----------------------------------------------------------------------
	'data_auth_key' => 'V2g6ySbxvs;<Im)=1L|Yq].BGf$uC#@/}pt&k,Zr', //默认数据加密KEY
	'data_cache_key'=> 'V2g6ySbxvs;<Im)=1L|Yq].BGf$uC#@/}pt&k,Zr',
    // +----------------------------------------------------------------------
    // | UCenter客户端配置
    // +----------------------------------------------------------------------
    'uc_app_id'   => 1,   //应用ID
    'uc_api_type' =>'Model',    //可选值 Model / Service
    'uc_auth_key' =>'V2g6ySbxvs;<Im)=1L|Yq].BGf$uC#@/}pt&k,Zr', //加密KEY
